...
static const std::map<std::string, std::string>& storefront_map() {
...
static std::string country_code_from_storefront(const std::string& sf) {
    ...
    for (auto& [cc, id] : storefront_map()) {
        if (id == numeric) return cc;
    }
